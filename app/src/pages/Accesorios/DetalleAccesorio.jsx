        ...
        <div className="container">
            ...
            <main className='main'>
                <div className="sidebar sidebar-detalle-juego">
                    ...
                    <Link to={`/accesorios/editar/${id}/${id_imagen}`} className="sidebar-btn">
                        <span className="material-icons">edit</span>
                        Editar Accesorio
                    </Link>
                    <button onClick={deleteAccesorio} className="sidebar-btn-delete">
                ...
                <div className='container-main'>
                    <div className="detalle-juego-overlay">
                        <Breadcrumb items={[
                            ...
                            { label: accesorio.nombre, active: true }
                        ]}/>
                        
                        <div className="detalle-juego">
                            <h3 className="detalle-juego-title">
                                <span>Accesorio</span>{accesorio.nombre}
                            </h3>
                            
                            <p className='detalle-juego-description'>Estado: {accesorio.estado}</p>
                            
                            <div className="detalle-juego-price">
                                <p className="detalle-juego-price-title">Precio</p>
                                <p className="detalle-juego-price-value">${accesorio.precio?.toLocaleString("es-CL") || 0}</p>
                        ...
                        <div className='detalle-juego-cards'>
                            <div className='detalle-juego-card'>
                                <p className='detalle-juego-card-text'>Tipo</p>
                                <h4 className='detalle-juego-card-title'>{accesorio.tipo || '-'}</h4>
                            </div>
                            <div className='detalle-juego-card'>
                            ...
                            <div className='detalle-juego-card'>
                                ...
                                <h4 className='detalle-juego-card-title'>{accesorio.anio || '-'}</h4>
                            </div>
                        </div>
                        ...
                        {accesorio.comentario && (
                            <div className='detalle-juego-comentario'>
                                ...
                                <p className='detalle-juego-comentario-text'>{accesorio.comentario}</p>
                            </div>
                        )}
